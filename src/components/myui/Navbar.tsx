...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div>
        <nav className="w-full max-w-screen h-[45px] flex items-center bg-black bg-opacity-90 sticky top-3 shadow lg:px-2 backdrop-blur-lg backdrop-saturate-150 z-[100]">
          <div className="w-full flex items-center justify-between text-slate-800 px-8">
            <div className="mr-4 font-bold flex lg:flex-1">
              <Link
                ...
                className="flex"
              >
                <CodeXml className="text-[#00ffcc] mr-2" />
